...
#[path = "../../tests/notes_listing_index_meta.rs"]
mod notes_listing_index_meta;
...
#[path = "../../tests/search_scan_vault_excludes.rs"]
    ...
    fn export_bindings() {
        ...
        Builder::<tauri::Wry>::new()
            .commands(collect_commands![
                ...
                crate::features::search::service::get_storage_stats,
                crate::features::search::service::cleanup_orphaned_dbs,
