...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .manage(std::sync::Arc::new(features::ai::permissions::PermissionEngine::default()))
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            features::search::service::find_missing_links,
            features::search::service::search_blocks,
            ...
            features::bases::service::list_types,
            ...
            features::notes::service::find_notes_by_name,
            ...
            features::notes::proposal_mutations::prepare_proposal_rename,
            features::notes::proposal_mutations::apply_proposal_mutations,
            features::notes::proposal_mutations::prepare_proposal_restore,
            ...
            features::clip::service::clip_fetch_page,
            features::clip::service::clip_fetch_asset,
            features::clip::service::clip_write_epub,
            features::clip::capture::clip_capture_start,
            features::clip::capture::clip_capture_finish,
            features::clip::capture::clip_capture_cancel,
            ...
            features::code_lsp::code_lsp_did_change,
            features::code_lsp::code_lsp_hover,
            features::code_lsp::code_lsp_completion,
            features::code_lsp::code_lsp_definition,
            features::code_lsp::code_lsp_code_actions,
            ...
            features::markdown_lsp::service::markdown_lsp_config_status,
            features::markdown_lsp::service::markdown_lsp_config_reset,
            ...
            features::search::service::search_headings,
            ...
            features::trusted_html::trusted_html_get_level,
            features::trusted_html::trusted_html_list,
